...
public class StringToCharExpressionNode extends ExpressionNode {
  public final ExpressionNode expression;

  public StringToCharExpressionNode(ExpressionNode expression) {
