...
public class PascalParser extends Parser {
	...
	public static final int
		...
		RULE_constant_deifinition = 3, RULE_constant = 4, RULE_primitive_type = 5, 
		RULE_type_definition = 6, RULE_type_denoter = 7, RULE_identifier_list = 8, 
		RULE_subrange_type = 9, RULE_array_type = 10, RULE_variable_declaration = 11, 
		RULE_variable_access = 12, RULE_indexed_variable = 13, RULE_procedure_declaration = 14, 
		RULE_procedure_heading = 15, RULE_function_declaration = 16, RULE_function_heading = 17, 
		RULE_formal_parameter_list = 18, RULE_value_parameter_speficiation = 19, 
		RULE_expression = 20, RULE_simple_expression = 21, RULE_term = 22, RULE_factor = 23, 
		RULE_unsigned_constant = 24, RULE_multiplying_operator = 25, RULE_adding_operator = 26, 
		RULE_relational_operator = 27, RULE_function_designator = 28, RULE_actual_parameter_list = 29, 
		RULE_actual_parameter = 30, RULE_statement = 31, RULE_simple_statement = 32, 
		RULE_empty_statement = 33, RULE_assignment_statement = 34, RULE_procedure_statement = 35, 
		RULE_structured_statement = 36, RULE_statement_sequence = 37, RULE_compound_statement = 38, 
		RULE_if_statement = 39, RULE_else_part = 40, RULE_for_statement = 41, 
		RULE_program = 42, RULE_program_heading = 43;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"value_parameter_speficiation", "expression", "simple_expression", "term", 
			"factor", "unsigned_constant", "multiplying_operator", "adding_operator", 
			"relational_operator", "function_designator", "actual_parameter_list", 
			"actual_parameter", "statement", "simple_statement", "empty_statement", 
			"assignment_statement", "procedure_statement", "structured_statement", 
	...
	public final Constant_deifinitionContext constant_deifinition() throws RecognitionException {
		...
		enterRule(_localctx, 6, RULE_constant_deifinition);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(119);
	...
	public final Type_denoterContext type_denoter() throws RecognitionException {
		...
		enterRule(_localctx, 14, RULE_type_denoter);
		try {
			setState(142);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final Subrange_typeContext subrange_type() throws RecognitionException {
		...
		enterRule(_localctx, 18, RULE_subrange_type);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(152);
	...
	public final Variable_accessContext variable_access() throws RecognitionException {
		...
		enterRule(_localctx, 24, RULE_variable_access);
		try {
			setState(179);
			_errHandler.sync(this);
	...
	public final Indexed_variableContext indexed_variable() throws RecognitionException {
		...
		enterRule(_localctx, 26, RULE_indexed_variable);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Procedure_headingContext procedure_heading() throws RecognitionException {
		...
		enterRule(_localctx, 30, RULE_procedure_heading);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Function_headingContext function_heading() throws RecognitionException {
		...
		enterRule(_localctx, 34, RULE_function_heading);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Value_parameter_speficiationContext value_parameter_speficiation() throws RecognitionException {
		...
		enterRule(_localctx, 38, RULE_value_parameter_speficiation);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(230);
	...
	public final Unsigned_constantContext unsigned_constant() throws RecognitionException {
		...
		enterRule(_localctx, 48, RULE_unsigned_constant);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Multiplying_operatorContext multiplying_operator() throws RecognitionException {
		...
		enterRule(_localctx, 50, RULE_multiplying_operator);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Adding_operatorContext adding_operator() throws RecognitionException {
		...
		enterRule(_localctx, 52, RULE_adding_operator);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Function_designatorContext function_designator() throws RecognitionException {
		...
		enterRule(_localctx, 56, RULE_function_designator);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Actual_parameterContext actual_parameter() throws RecognitionException {
		...
		enterRule(_localctx, 60, RULE_actual_parameter);
		try {
			setState(298);
			_errHandler.sync(this);
	...
	public final Simple_statementContext simple_statement() throws RecognitionException {
		...
		enterRule(_localctx, 64, RULE_simple_statement);
		try {
			setState(311);
			_errHandler.sync(this);
	...
	public final Assignment_statementContext assignment_statement() throws RecognitionException {
		...
		enterRule(_localctx, 68, RULE_assignment_statement);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(315);
	...
	public final Procedure_statementContext procedure_statement() throws RecognitionException {
		...
		enterRule(_localctx, 70, RULE_procedure_statement);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Structured_statementContext structured_statement() throws RecognitionException {
		...
		enterRule(_localctx, 72, RULE_structured_statement);
		try {
			setState(326);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final Statement_sequenceContext statement_sequence() throws RecognitionException {
		...
		enterRule(_localctx, 74, RULE_statement_sequence);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Program_headingContext program_heading() throws RecognitionException {
		...
		enterRule(_localctx, 86, RULE_program_heading);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
