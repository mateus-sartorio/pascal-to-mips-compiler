...
constant: (( PLUS | MINUS)? UNSIGNED_INTEGER | UNSIGNED_REAL)
	| CHARACTER_STRING;
...
// 6.4.3 Structured-types Not needed

// 6.4.3.2 Array-types
array_type: (PACKED)? ARRAY OPEN_BRACKET subrange_type (
		COMMA subrange_type
	)* CLOSE_BRACKET OF type_denoter;

// 6.4.3.3 Record-types Will not be implemented

// 6.4.3.4 Set-types Will not be implemented

// 6.4.3.5 File-types Will not be implemented

// 6.4.4 Pointer-types Will not be implemented
...
// 6.5.2 Entire-variables Not needed

// 6.5.3 Component-variables Not needed

// 6.5.3.2 Indexed-variables
indexed_variable:
	IDENTIFIER OPEN_BRACKET (expression ( COMMA expression)*) CLOSE_BRACKET;

// 6.5.3.3 Field-designators Will not be implemented

// 6.5.5 Buffer-variables Will not be implemented
...
procedure_declaration:
	procedure_heading SEMICOLON compound_statement;
...
function_declaration:
	function_heading SEMICOLON compound_statement;
...
// 6.6.3.7 Conformant array parameters Will not be implemented
...
actual_parameter_list:
	OPEN_PARENTHESIS actual_parameter (COMMA actual_parameter)* CLOSE_PARENTHESIS;
...
// 6.8.2.4 Goto-statements Will not be implemented
...
// 6.8.3.3 Conditional-statements Not needed

// 6 .8 .3 .4 If-statements
if_statement: IF expression THEN statement ( else_part)?;
else_part: ELSE statement;

// 6.8.3.5 Case-statements Will not be implemented

// 6.8.3.6 Repetitive-statements Not needed

// 6.8.3.7 Repeat-statements Will not be implemented

// 6.8.3.8 While-statements Will not be implemented

// 6.8.3.9 For-statements
for_statement:
	FOR IDENTIFIER ASSIGNMENT expression (TO | DOWNTO) expression DO statement;

// 6.8.3.10 With-statements Will not be implemented
