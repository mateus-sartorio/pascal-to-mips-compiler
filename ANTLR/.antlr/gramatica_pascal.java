...
public class gramatica_pascal extends Lexer {
	...
	public static final int
		...
		WHILE=34, WITH=35, ATRIBUITION=36, NOTEQUALTO=37, LESSTHENEQTO=38, GRETERTHENEQTO=39, 
		RANGE=40, ADD=41, SUB=42, EQUAL=43, VERSUS=44, DIVISOR=45, LESSTHEN=46, 
		MORETHEN=47, OPBRACKET=48, CLBRACKET=49, DOT=50, COMMAN=51, COLON=52, 
		SEMICOLON=53, OPPARENTHESES=54, CLPARENTHESES=55, ID=56, DIRECTIVE=57, 
		UNSIGNED_NUMBER=58, SIGNED_INTEGER=59;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"CLPARENTHESES", "ID", "DIRECTIVE", "DIGIT", "DIGIT_SEQUENCE", "SIGN", 
			"SCALE_FACTOR", "FRACTIONAL_PART", "UNSIGNED_ITEGER", "UNSIGNED_REAL", 
			"UNSIGNED_NUMBER", "SIGNED_INTEGER"
		};
	}
